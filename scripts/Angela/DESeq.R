...
#a factor=levels tfor a certain variable; telling deseq it is a variable. for example, 1=LD and 2=ND and then ask R to compare 1 and 2
...
# see what percentage of the variance can be explained by PC1
