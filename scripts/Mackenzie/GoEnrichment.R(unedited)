...
interesting_genes <- "../misc/21D_DvND_test.txt" #This file is a single column of gene IDs with no header
project_description <- "larva 11d" #Name given for creating GO data object (something like "My project" or "larva 11d")
