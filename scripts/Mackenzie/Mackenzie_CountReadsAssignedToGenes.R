...
raw_data <- read_bulk(directory = "/Users/mackenzieparsons/Downloads/HTSeqfiles", fun = read.table, header = F)
...
write.csv(col_dat, file = "/Users/mackenzieparsons/Downloads/misc/htseqCount_ReadsAssignedGene.csv")
