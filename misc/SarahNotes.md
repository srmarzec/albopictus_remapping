...
Information about [stranded RNA data](https://chipster.csc.fi/manual/library-type-summary.html) basically says we can check the output files from HTSeq to see which flag we should use.
